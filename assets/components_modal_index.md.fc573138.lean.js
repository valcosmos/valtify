...
`),l("span",{class:"line"})])])],-1);function g(F,e,n,a,D,y){const t=u("render-demo-0"),c=u("demo");return E(),V("div",null,[M,w,d(c,{customClass:"undefined",sourceCode:`<template>
...
<\/script>
`},{highlight:i(()=>[k]),default:i(()=>[d(t)]),_:1})])}const $=b(x,[["render",g]]);export{O as __pageData,$ as default};
