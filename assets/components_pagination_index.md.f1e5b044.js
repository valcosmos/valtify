import{a2 as F,_ as E,D as d,o as S,c as z,G as m,B as f,z as s,a as l}from"./chunks/framework.8da487b1.js";const{defineComponent:g}=F,x=g({name:"component-doc",components:{"render-demo-0":function(){const{renderList:y,Fragment:D,openBlock:t,createElementBlock:c,toDisplayString:i,resolveComponent:C,createVNode:r}=F;function p(o,n){const e=C("VPagination");return t(),c("div",null,[(t(!0),c(D,null,y(o.data,(a,A)=>(t(),c("div",{key:A},i(a),1))),128)),r(e,{total:o.source.length,modelValue:o.current,"onUpdate:modelValue":n[0]||(n[0]=a=>o.current=a),pageSize:o.pageSize},null,8,["total","modelValue","pageSize"])])}const{ref:u,computed:v}=F,_=g({setup(){const o=Array.from({length:1e3},()=>1).map((A,h)=>`第${h}条数据`),n=u(1),e=u(10),a=v(()=>o.slice((n.value-1)*e.value,n.value*e.value));return{source:o,current:n,pageSize:e,data:a}}});return{render:p,..._}}()}}),N=JSON.parse('{"title":"分页","description":"","frontmatter":{},"headers":[],"relativePath":"components/pagination/index.md","filePath":"components/pagination/index.md"}'),V=s("h1",{id:"分页",tabindex:"-1"},[l("分页 "),s("a",{class:"header-anchor",href:"#分页","aria-label":'Permalink to "分页"'},"​")],-1),k=s("h2",{id:"基本用法",tabindex:"-1"},[l("基本用法 "),s("a",{class:"header-anchor",href:"#基本用法","aria-label":'Permalink to "基本用法"'},"​")],-1),B=s("div",{class:"language-vue"},[s("pre",{"v-pre":"",class:"shiki material-theme-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#89DDFF"}},"<"),s("span",{style:{color:"#F07178"}},"template"),s("span",{style:{color:"#89DDFF"}},">")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#89DDFF"}},"</"),s("span",{style:{color:"#F07178"}},"script"),s("span",{style:{color:"#89DDFF"}},">")])])])],-1);function P(y,D,t,c,i,C){const r=d("render-demo-0"),p=d("demo");return S(),z("div",null,[V,k,m(p,{customClass:"undefined",sourceCode:`<template>
  <div>
...
<\/script>
`},{highlight:f(()=>[B]),default:f(()=>[m(r)]),_:1})])}const b=E(x,[["render",P]]);export{N as __pageData,b as default};
