import{V as p,_ as V,c as E,a as i,w as d,b as l,d as o,r as C,o as B}from"./app.f32c9cb0.js";const{defineComponent:u}=p,x=u({name:"component-doc",components:{"render-demo-0":function(){const{createTextVNode:F,resolveComponent:e,withCtx:n,createVNode:a,createElementVNode:D,Fragment:y,openBlock:t,createElementBlock:c}=p,m=D("p",null,"Modal",-1);function A(s,r){const h=e("v-button"),v=e("v-modal");return t(),c(y,null,[a(h,{type:"primary",onClick:s.showModal},{default:n(()=>[F("Open")]),_:1},8,["onClick"]),a(v,{modelValue:s.modalVisible,"onUpdate:modelValue":r[0]||(r[0]=b=>s.modalVisible=b),title:"Header",closable:"",centered:""},{default:n(()=>[m]),_:1},8,["modelValue"])],64)}const{ref:_}=p,f=u({setup(){const s=_(!1);return{modalVisible:s,showModal:()=>s.value=!0}}});return{render:A,...f}}()}}),O=JSON.parse('{"title":"Modal-对话框","description":"","frontmatter":{},"headers":[{"level":2,"title":"基本对话框","slug":"基本对话框","link":"#基本对话框","children":[]}],"relativePath":"components/modal/index.md"}'),M=l("h1",{id:"modal-对话框",tabindex:"-1"},[o("Modal-对话框 "),l("a",{class:"header-anchor",href:"#modal-对话框","aria-hidden":"true"},"#")],-1),w=l("h2",{id:"基本对话框",tabindex:"-1"},[o("基本对话框 "),l("a",{class:"header-anchor",href:"#基本对话框","aria-hidden":"true"},"#")],-1),k=l("div",{class:"language-vue"},[l("pre",{"v-pre":"",class:"shiki material-theme-palenight",tabindex:"0"},[l("code",null,[l("span",{class:"line"},[l("span",{style:{color:"#89DDFF"}},"<"),l("span",{style:{color:"#F07178"}},"template"),l("span",{style:{color:"#89DDFF"}},">")]),o(`
