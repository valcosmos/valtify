import{V as D,_ as w,c as b,a as C,w as p,b as s,d as l,r as d,o as E}from"./app.f32c9cb0.js";const{defineComponent:B}=D,x=B({name:"component-doc",components:{"render-demo-0":function(){const{createTextVNode:F,resolveComponent:e,withCtx:n,createVNode:t,createElementVNode:y,openBlock:i,createElementBlock:a}=D,r=y("div",null,"Hello world",-1);function A(o,c){const _=e("v-button"),f=e("v-drawer");return i(),a("div",null,[t(_,{type:"primary",onClick:o.showDrawer},{default:n(()=>[F("Open")]),_:1},8,["onClick"]),t(f,{visible:o.visible,"onUpdate:visible":c[0]||(c[0]=h=>o.visible=h),title:"Basic Drawer"},{default:n(()=>[r]),_:1},8,["visible"])])}const{defineComponent:u,ref:v}=D,m=u({setup(){const o=v(!1);return{visible:o,showDrawer:()=>{o.value=!0}}}});return{render:A,...m}}()}}),H=JSON.parse('{"title":"抽屉","description":"","frontmatter":{},"headers":[{"level":2,"title":"普通抽屉","slug":"普通抽屉","link":"#普通抽屉","children":[]}],"relativePath":"components/drawer/index.md"}'),k=s("h1",{id:"抽屉",tabindex:"-1"},[l("抽屉 "),s("a",{class:"header-anchor",href:"#抽屉","aria-hidden":"true"},"#")],-1),V=s("h2",{id:"普通抽屉",tabindex:"-1"},[l("普通抽屉 "),s("a",{class:"header-anchor",href:"#普通抽屉","aria-hidden":"true"},"#")],-1),N=s("div",null,"It is a Drawer component",-1),g=s("div",{class:"language-vue"},[s("pre",{"v-pre":"",class:"shiki material-theme-palenight",tabindex:"0"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#89DDFF"}},"<"),s("span",{style:{color:"#F07178"}},"script"),s("span",{style:{color:"#A6ACCD"}}," "),s("span",{style:{color:"#C792EA"}},"lang"),s("span",{style:{color:"#89DDFF"}},"="),s("span",{style:{color:"#89DDFF"}},'"'),s("span",{style:{color:"#C3E88D"}},"ts"),s("span",{style:{color:"#89DDFF"}},'"'),s("span",{style:{color:"#89DDFF"}},">")]),l(`
...
`},{description:p(()=>[N]),highlight:p(()=>[g]),default:p(()=>[C(a)]),_:1})])}const T=w(x,[["render",O]]);export{H as __pageData,T as default};
