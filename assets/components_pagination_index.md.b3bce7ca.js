...
`),s("span",{class:"line"},[s("span",{style:{color:"#89DDFF"}},"</"),s("span",{style:{color:"#F07178"}},"script"),s("span",{style:{color:"#89DDFF"}},">")])])])],-1);function P(y,D,t,c,i,C){const r=f("render-demo-0"),p=f("demo");return z(),S("div",null,[k,x,d(p,{customClass:"undefined",sourceCode:`<template>
  <div>
...
<\/script>
`},{highlight:m(()=>[B]),default:m(()=>[d(r)]),_:1})])}const b=E(V,[["render",P]]);export{N as __pageData,b as default};
