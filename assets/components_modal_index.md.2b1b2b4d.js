import{a1 as p,_ as b,c as V,D as i,z as d,x as l,a as o,B as C,o as E}from"./chunks/framework.90487ba1.js";const{defineComponent:u}=p,x=u({name:"component-doc",components:{"render-demo-0":function(){const{createTextVNode:F,resolveComponent:e,withCtx:n,createVNode:a,createElementVNode:D,Fragment:y,openBlock:t,createElementBlock:c}=p,m=D("p",null,"Modal",-1);function A(s,r){const h=e("v-button"),B=e("v-modal");return t(),c(y,null,[a(h,{type:"primary",onClick:s.showModal},{default:n(()=>[F("Open")]),_:1},8,["onClick"]),a(B,{modelValue:s.modalVisible,"onUpdate:modelValue":r[0]||(r[0]=v=>s.modalVisible=v),title:"Header",closable:"",centered:""},{default:n(()=>[m]),_:1},8,["modelValue"])],64)}const{ref:_}=p,f=u({setup(){const s=_(!1);return{modalVisible:s,showModal:()=>s.value=!0}}});return{render:A,...f}}()}}),O=JSON.parse('{"title":"Modal-对话框","description":"","frontmatter":{},"headers":[],"relativePath":"components/modal/index.md"}'),M=l("h1",{id:"modal-对话框",tabindex:"-1"},[o("Modal-对话框 "),l("a",{class:"header-anchor",href:"#modal-对话框","aria-label":'Permalink to "Modal-对话框"'},"​")],-1),k=l("h2",{id:"基本对话框",tabindex:"-1"},[o("基本对话框 "),l("a",{class:"header-anchor",href:"#基本对话框","aria-label":'Permalink to "基本对话框"'},"​")],-1),w=l("div",{class:"language-vue"},[l("pre",{"v-pre":"",class:"shiki material-theme-palenight"},[l("code",null,[l("span",{class:"line"},[l("span",{style:{color:"#89DDFF"}},"<"),l("span",{style:{color:"#F07178"}},"template"),l("span",{style:{color:"#89DDFF"}},">")]),o(`
...
`),l("span",{class:"line"})])])],-1);function g(F,e,n,a,D,y){const t=C("render-demo-0"),c=C("demo");return E(),V("div",null,[M,k,i(c,{customClass:"undefined",sourceCode:`<template>
...
<\/script>
`},{highlight:d(()=>[w]),default:d(()=>[i(t)]),_:1})])}const $=b(x,[["render",g]]);export{O as __pageData,$ as default};
