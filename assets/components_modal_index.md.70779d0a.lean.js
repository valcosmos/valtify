...
`),l("span",{class:"line"},[l("span",{style:{color:"#89DDFF"}},"</"),l("span",{style:{color:"#F07178"}},"script"),l("span",{style:{color:"#89DDFF"}},">")])])])],-1);function g(F,e,n,a,D,y){const t=C("render-demo-0"),c=C("demo");return E(),V("div",null,[x,k,i(c,{customClass:"undefined",sourceCode:`<template>
...
<\/script>
`},{highlight:d(()=>[w]),default:d(()=>[i(t)]),_:1})])}const $=b(M,[["render",g]]);export{O as __pageData,$ as default};
