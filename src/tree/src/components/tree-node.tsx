...
export default defineComponent({
  ...
  setup(props: TreeNodeProps, { slots }) {
    ...
    return () => (
      <div
        class="v-tree__node relative leading-8 hover:bg-slate-300"
        style={{
      ...
      >
        ...
        {!treeNode.value.isLeaf && treeNode.value.expanded && lineable.value && (
          <span
            class="v-tree-node__vline absolute w-px bg-slate-300"
            style={{
              height: `${
        ...
        <div class="v-tree__node--content" {...dragdropProps}>
